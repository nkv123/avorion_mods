...
-- namespace SpawnSwoks
SpawnSwoks = {}

function SpawnSwoks.initialize()
...
function SpawnSwoks.onSectorEntered(player, x, y)
    ...
    SpawnSwoks.spawnEnemies(Player(player), x, y)

end

function SpawnSwoks.spawnEnemies(player, x, y)
...
function SpawnSwoks.onBossDestroyed()
...
function SpawnSwoks.getUpdateInterval()
    return 60
end

function SpawnSwoks.updateServer(timeStep)
